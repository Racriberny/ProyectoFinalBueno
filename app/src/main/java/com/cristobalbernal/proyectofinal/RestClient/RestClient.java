package com.cristobalbernal.proyectofinal.RestClient;
import com.cristobalbernal.proyectofinal.Interfaces.IAPIService;
...
public class RestClient {
    ...
    public static final String CASA = "192.168.1.122";
